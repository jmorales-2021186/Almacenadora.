...
export const Table = () => {
  ...
  const getUsers = async () => {
    try {
      ...
      // users.map(({ name, surname, username, email, phone, role }, index) => {
      //   console.log(name, surname, username, email, phone, role);
      // });
        ...
        <tbody>
          {existUsers.map(
            ({ _id, name, surname, username, email, phone, role }, index) => {
              console.log(_id, name, surname, username, email, phone, role);
              return (
                <>
