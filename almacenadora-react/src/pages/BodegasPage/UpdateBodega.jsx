        ...
        <>
            <form className="m-5 text-center">
                <div className="mb-3">
                    ...
                    <input type="text" defaultValue={bodegas.name} className="form-control" id="inputName" required />
                </div>
                <div className="mb-3">
                    <label htmlFor="inputLocation" className="form-labler">Locacion</label>
                    <input type="text" defaultValue={bodegas.location} className="form-control" id="inputLocation" required />
                </div>
                <div className="mb-3">
                    <label htmlFor="inputSize" className="form-labler">Tamaño</label>
                    <input type="text" defaultValue={bodegas.size} className="form-control" id="inputSize" required />
                </div>
                <div className="mb-3">
                    <label htmlFor="inputPrice" className="form-labler">Price</label>
                    <input type="number" defaultValue={bodegas.price} className="form-control" id="inputPrice" required />
                </div>
                <div className="mb-3">
                    <label htmlFor="inputDescription" className="form-labler">Descripcion</label>
                    <input type="text" defaultValue={bodegas.description} className="form-control" id="inputDescription" required />
                </div>
                <div className="mb-3">
                    <label htmlFor="inputAvailability" className="form-labler">Disponibilidad</label>
                    <input type="text" defaultValue={bodegas.availability} className="form-control" id="inputAvailability" required />
                </div>
